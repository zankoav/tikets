		...
		<div class="main-slider__wrapper swiper-wrapper">
			<?php foreach($crb_slides as $crb_slide) :
				...
				<div class="slide swiper-slide">
					<div class="container">
						<div class="row">
							<div class="col-12 col-sm-5 col-lg-6 col-hd-5">
								<div class="pl-sm-10 pl-md-20 pl-lg-40">
									...
									<div class="slide__button-wrapper mb-10 pb-10">
										<a class="orange-button orange-button__type_1" href="<?= $slide_link; ?>">Подробнее</a>
									</div>
								</div>
							</div>
							<div class="slide__order-1 col-12 col-sm-7 col-lg-6 col-hd-7">
								<div class="slide__img-wrapper">
									<img class="slide__img" src="<?= $slide_image; ?>"
