var checkout = (window.webpackJsonp_name_ = window.webpackJsonp_name_ || []).push([[2], {
    66: function (e, t) {
        ...
        let i = l()(".types__form").data("program-id"), p = l()(".promokod__price"), _ = l()(".promokod__result"),
            c = parseInt(_.text()), d = {}, u = l()(".checkout-form-group__select option");
        ...
        !function () {
            ...
            e.on("click", function (e) {
                ...
                console.log(o), l.a.ajax({
                    type: "POST", url: tikets_ajax.url, data: s, success: function (e) {
                        console.log(e);
                        let o = JSON.parse(e);
                        if (console.log(o), y = (v = o).status, g = v.text, k = v.discount_type, b = v.coupon_amount, 0 === y) {
                            let e = t.parent().parent();
                            return e.addClass("checkout-form-group_error"), e.find(".checkout-form-group__message").html(g), void h()
                        }
                        {
                            let e = t.parent().parent();
                            return e.addClass("checkout-form-group_green"), e.find(".checkout-form-group__message").html(g), void h()
                        }
                    }, error: function (e, s, r) {
                        if (console.log(e), 0 === o.length) {
                            let e = t.parent().parent();
                            return e.addClass("checkout-form-group_error"), e.find(".checkout-form-group__message").html(a.a.ERROR_EMPTY_PROMOCODE_FIELD), void h()
                        }
                    }
                })
            }), t.on("focus", j)
            ...
            e.preventDefault(), c++, _.html(c), h()
        }), l()(".promokod__minus").on("click", function (e) {
            e.preventDefault(), c > 1 && (c--, _.html(c), h())
        ...
        function h() {
            ...
            if (1 === y) switch (k) {
                case"percent":
                    if (t) {
                        let e = c * parseFloat(t), o = e - e * (b / 100);
                        p.html(o.toFixed(2) + " ")
                    }
                    break;
                case"fixed_cart":
                    if (t) {
                        let e = c * parseFloat(t) - b;
                        p.html(e.toFixed(2) + " ")
                    }
                    break;
                case"fixed_product":
                    if (t) {
                        let e = c * parseFloat(t) - c * b;
                        p.html(e.toFixed(2) + " ")
                    }
            } else if (1 === o.status) if (f.length > 0) for (let e = 0; e < f.length; e++) {
                if (c >= +f[e].quantity_from && c <= +f[e].quantity_to) {
                    let o = c * parseFloat(t) * (+f[e].discount / 100), a = c * parseFloat(t) - o;
                    p.html(a.toFixed(2) + " ");
                    break
                }
                {
        ...
        var v = [], y = null, g = null, k = null, b = null;
        l()(".types__button-chekout").on("click", function (e) {
            e.preventDefault(), console.log("gg");
            let t = C.val(), o = R.val(), s = E.val(), r = w.val(), n = F.val();
            ...
            l()(this).find("[name*='email']").removeClass("input_error");
            let p = {action: "sendFormTo", name: t, komp: o, col: s, phone: r, email: n, programId: i};
            l.a.ajax({
                type: "POST", url: tikets_ajax.url, data: p, beforeSend: function () {
                    l()(".preloader").addClass("preloader_active")
                }, success: function (e) {
                    console.log(e);
                    let t = JSON.parse(e);
                    l()("#form2")[0].reset(),
                    1 === t.status && l()(".types__response").text(t.text),
                    0 === t.status && l()(".types__response").text(t.text),
                        l()("#form2")[0].reset(),
                        l()(".preloader").removeClass("preloader_active")
                }, error: function (e, t, o) {
                    console.log(e), l()(".preloader").removeClass("preloader_active"), l()(".types__response").text("ОШИБКА!")
                }
            })
        });
        let C = l()("[name='name']"), R = l()("[name='komp']"), E = l()("[name='col']"), w = l()("[name='phone']"),
            F = l()("[name='email']"), x = l()('[name="user-phone"]'), O = l()('[name="user-name"]'),
            D = l()('[name="user-email"]'), I = l()('[name="user-comment"]'), T = l()('[name="message"]');
        ...
        x.on("focus", j), O.on("focus", j), D.on("focus", j), r()({regex: String.raw`^\+375 (17|25|29|33|44) [0-9]{3} [0-9]{2} [0-9]{2}$`}).mask(x[0]), l()(".promokod__button-chekout").on("click", function (e) {
            e.preventDefault();
            let t = x.val(), o = O.val(), s = D.val(), r = I.val(),
                n = l()(".checkout-form-group__select").find(":selected").val(), p = T.val(),
                _ = l()("#user-promokod").val();
            if (0 === t.length) {
            ...
            d = {
                ...
                userPromocode: _,
                action: "createOrder"
            }, console.log("send data:", d), l.a.ajax(tikets_ajax.url, {
                data: d,
                method: "post",
                dataType: "json",
                beforeSend: function () {
                ...
                success: function (e) {
                    !function (e) {
                        ...
                        t.method = "POST", console.log(e), console.log("check test: " + e.wsb_test), 1 == +e.wsb_test ? t.action = "https://securesandbox.webpay.by/" : 0 == +e.wsb_test && (t.action = "https://payment.webpay.by");
                        for (let o in e) {
