var checkout = (window.webpackJsonp_name_ = window.webpackJsonp_name_ || []).push([[2], {
    66: function (e, t) {
            ...
            e.on("click", function (e) {
                ...
                console.log(o), l.a.ajax({
                    type: "POST", url: tikets_ajax.url, data: s, success: function (e) {
                        console.log(e);
                        let o = JSON.parse(e);
                        if (console.log(o), g = (v = o).status, y = v.text, k = v.discount_type, b = v.coupon_amount, 0 === g) {
        ...
        var v = [], g = null, y = null, k = null, b = null;
        ...
        O.on("focus", j), D.on("focus", j), x.on("focus", j), r()({regex: String.raw`^\+375 (17|25|29|33|44) [0-9]{3} [0-9]{2} [0-9]{2}$`}).mask(O[0]), l()(".promokod__button-chekout").on("click", function (e) {
            e.preventDefault();
            let t = O.val(), o = D.val(), s = x.val(), r = I.val(),
                n = l()(".checkout-form-group__select").find(":selected").val(), _ = T.val(),
                p = l()("#user-promokod").val();
            if (0 === t.length) {
