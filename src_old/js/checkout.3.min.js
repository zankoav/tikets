var checkout = (window.webpackJsonp_name_ = window.webpackJsonp_name_ || []).push([[2], {
    66: function (e, t) {
        ...
        var a = o(1), s = o(10), r = o.n(s), n = o(0), l = o.n(n);
            ...
            e.on("click", function (e) {
                ...
                console.log(o), l.a.ajax({
                    type: "POST", url: tikets_ajax.url, data: s, success: function (e) {
                        console.log(e);
                        let o = JSON.parse(e);
                        if (console.log(o), E = (R = o).status, w = R.text, F = R.discount_type, O = R.coupon_amount, 0 === E) {
                            let e = t.parent().parent();
                            return e.addClass("checkout-form-group_error"), void e.find(".checkout-form-group__message").html(w)
                        }
                        {
                            let e = t.parent().parent();
                            return e.addClass("checkout-form-group_green"), void e.find(".checkout-form-group__message").html(w)
                        }
        ...
        function h() {
            ...
            if (1 === E) switch (F) {
                case"percent":
                    if (t) {
                        let e = c * parseFloat(t), o = e - e * (O / 100);
                        _.html(o.toFixed(2) + " ")
                    }
                    break;
                case"fixed_cart":
                    if (t) {
                        let e = c * parseFloat(t) - O;
                        _.html(e.toFixed(2) + " ")
                    }
                    break;
                case"fixed_product":
                    if (t) {
                        let e = c * parseFloat(t) - c * O;
                        _.html(e.toFixed(2) + " ")
                    }
        ...
        let v = l()('[name="user-phone"]'), g = l()('[name="user-name"]'), y = l()('[name="user-email"]'),
            k = l()('[name="user-comment"]'), C = l()('[name="message"]');
        ...
        v.on("focus", b), g.on("focus", b), y.on("focus", b),
            //r()({regex: String.raw`^\+375 (17|25|29|33|44) [0-9]{3} [0-9]{2} [0-9]{2}$`}).mask(v[0]),
            l()(".promokod__button-chekout").on("click", function (e) {
            e.preventDefault();
            let t = v.val(), o = g.val(), s = y.val(), r = k.val(),
                n = l()(".checkout-form-group__select").find(":selected").val(), _ = C.val();
            if (0 === t.length) {
            ...
            if (0 === o.length) {
                let e = g.parent().parent();
                e.addClass("checkout-form-group_error"), e.find(".checkout-form-group__message").html(a.a.ERROR_REQUIRE_FIELD);
                let t = e.offset().top - l()(".header").height() - 40;
                return void l()("html, body").animate({scrollTop: t}, 400)
            }
            if (0 === s.length) {
                let e = y.parent().parent();
                e.addClass("checkout-form-group_error"), e.find(".checkout-form-group__message").html(a.a.ERROR_REQUIRE_FIELD);
                let t = e.offset().top - l()(".header").height() - 40;
                return void l()("html, body").animate({scrollTop: t}, 400)
            }
        ...
        var R = [], E = null, w = null, F = null, O = null;
        l()(".types__button-chekout").on("click", function (e) {
            e.preventDefault(),
                //r()({regex: String.raw`^\+375 (17|25|29|33|44) [0-9]{3} [0-9]{2} [0-9]{2}$`}).mask(T[0]),
                console.log("gg");
            let t = D.val(), o = x.val(), s = I.val(), n = T.val(), _ = j.val();
            ...
            if (0 === n.length) return console.log("phone", a.a.ERROR_EMPTY_FIELD), void l()(this).find("[name*='phone']").addClass("input_error");
            l()(this).find("[name*='phone']").removeClass("input_error");
            if (!a.a.phone(n)) return console.log("phone", a.a.ERROR_PHONE_FORMAT_FIELD), void l()(this).find("[name*='phone']").addClass("input_error");
            l()(this).find("[name*='phone']").removeClass("input_error");
            if (0 === _.length) return console.log("email", a.a.ERROR_EMPTY_FIELD), void l()(this).find("[name*='email']").addClass("input_error");
            l()(this).find("[name*='email']").removeClass("input_error");
            if (!a.a.email(_)) return console.log("email", a.a.ERROR_EMAIL_FIELD), void l()(this).find("[name*='email']").addClass("input_error");
            l()(this).find("[name*='email']").removeClass("input_error");
            let p = {action: "sendFormTo", name: t, komp: o, col: s, phone: n, email: _, programId: i};
            l.a.ajax({
                type: "POST", url: tikets_ajax.url, data: p, success: function (e) {
                    console.log(e);
                    JSON.parse(e);
                    l()("#form2")[0].reset()
                }
        ...
        let D = l()("[name='name']"), x = l()("[name='komp']"), I = l()("[name='col']"), T = l()("[name='phone']"),
            j = l()("[name='email']");
        o(67);
