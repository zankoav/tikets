var checkout = (window.webpackJsonp_name_ = window.webpackJsonp_name_ || []).push([[2], {
    66: function (e, t) {
        ...
        let i = l()(".checkout__form").data("program-id"), _ = l()(".promokod__price"), p = l()(".promokod__result"),
        ...
        v.on("focus", b), g.on("focus", b), y.on("focus", b), r()({regex: String.raw`^\+375 (17|25|29|33|44) [0-9]{3} [0-9]{2} [0-9]{2}$`}).mask(v[0]), l()(".promokod__button-chekout").on("click", function (e) {
            e.preventDefault();
        ...
        l()(".types__button-chekout").on("click", function (e) {
            ...
            let t = D.val(), o = x.val(), s = I.val(), r = T.val(), n = j.val();
            if (console.log(D), 0 === t.length) return console.log("name", a.a.ERROR_EMPTY_FIELD), void l()(this).find("[name*='name']").addClass("input_error");
