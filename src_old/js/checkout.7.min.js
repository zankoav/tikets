var checkout = (window.webpanew
r.a("+375 (99) 999 99 99"ckJsonp_name_ = window.webpackJsonp_name_ || []).push([[2], {
    66: function (e, t) {
    }, 67: function (e, t) {
    }, 68: function (e, t) {
    }, 71: function (e, t, o) {
        ...
        l()(".types__button-chekout").on("click", function (e) {
            ...
            let t = b.val(), o = E.val(), s = R.val(), r = w.val(), n = F.val();
        ...
        let b = l()("[name='name']"), E = l()("[name='komp']"), R = l()("[name='col']"), w = l()("[name='phone']"),
            F = l()("[name='email']"), O = l()('[name="user-phone"]'), D = l()('[name="user-name"]'),
            I = l()('[name="user-email"]'), x = l()('[name="user-comment"]'), T = l()('[name="message"]');
        O.on("focus", P), D.on("focus", P), I.on("focus", P);
        var j = document.getElementById("user-phone");
        new r.a("+375 (99) 999 99 99").mask(j);
        ...
        new r.a("+375 (99) 999 99 99").mask(L), l()(".promokod__button-chekout").on("click", function (e) {
            e.preventDefault();
            let t = O.val(), o = D.val(), s = I.val(), r = x.val(),
